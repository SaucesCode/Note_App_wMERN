...
const NoteCard = ({ note }) => {
  ...
  const handlDelete = async (e, _id) => {
    e.preventDefault(); // also prevents navigation
  ...
  return (
    <Link
      to={`/note/${note._id}`}
      className="card bg-base-100 hover:shadow-lg transition-all duration-200  border-t-4 border-solid border-[#1f3260]"
    >
        ...
        <div className="card-actions justify-between items-center mt-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              onClick={e => handlDelete(e, note._id)}
            >
